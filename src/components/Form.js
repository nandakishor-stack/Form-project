...
export default function Form() {
  ...
  return (
    ...
    className="md:w-1/2 md:max-w-[1000px] rounded-md p-[30px] mx-auto flex flex-col gap-2 shadow-md bg-tahiti">
        {/* first name */}
        <div>
            <label 
            htmlFor="firstName"
        ...
        <div>
            ...
            <input 
            type="email" 
            placeholder='nandakishor417500@gmail.com' 
            id='email'
            name="email"
            onChange={inputChangeHandler}
        ...
        <div>
            ...
            name="streetAddress" 
            id="streetAddress"
            placeholder='105 karduba ghatshila'
            onChange={inputChangeHandler}
        ...
        {/* submit button */}
        <button 
        className='font-medium text-bermuda py-2 px-2 bg-silver rounded-md 
          hover:bg-metal w-[100px] h-[40px] transition-all duration-200 ' 
        type='submit'>
        Save
        </button>
    </form>
